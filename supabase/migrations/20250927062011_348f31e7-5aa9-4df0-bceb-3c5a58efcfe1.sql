...
-- Remove user_id from talent_profiles
ALTER TABLE public.talent_profiles DROP COLUMN user_id;

-- Add manager_id to track who created each talent profile
ALTER TABLE public.talent_profiles ADD COLUMN manager_id uuid REFERENCES public.managers(id);
