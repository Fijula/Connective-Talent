...
-- Create policies for managers (drop first to avoid conflicts)
...
-- Update talent_profiles policies
...
-- Add trigger for managers updated_at (drop first if exists)
